...
Write-host "Voulez-vous mettre à jour l'extension de la version $oldversion à la version $newversion sur le serveur $server? (défaut est non)" -ForegroundColor Yellow 
    ...
    { 
        O {
            ...
            Unpublish-NAVApp -ServerInstance $server -Name "ALGO" -Version $oldversion
