codeunit 50016 "VDOC - Export Xls V2"
{
    // //----------------------------------------------------------
    ...
    begin
        ...
        //Check sur la date de comptabilisation : uniquement les Lig Rcpt Ach Enreg depuis le 01/01/2021
        RecGPurchaseLine.SETFILTER(RecGPurchaseLine."Posting Date", '>%1', 20210101D);
