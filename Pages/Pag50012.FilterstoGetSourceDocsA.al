page 50012 "Filters to Get Source Docs.-A"
{
    // version NAVW111.00
    //copy from page 5784
    ...
    actions
    {
        area(processing)
        {
            action(Run)
            {
                ...
                trigger OnAction()
                var
                    GetSourceBatch: Report "Get Source Documents-ALGO";
                begin
                    case RequestType of
                        RequestType::Receive:
                            begin
                                GetSourceBatch.SetOneCreatedReceiptHeader(WhseReceiptHeader);
                                Rec.SetFilters2(GetSourceBatch, WhseReceiptHeader."Location Code");
                            end;
                        RequestType::Ship:
                            begin
                                GetSourceBatch.SetOneCreatedShptHeader(WhseShptHeader);
                                Rec.SetFilters2(GetSourceBatch, WhseShptHeader."Location Code");
