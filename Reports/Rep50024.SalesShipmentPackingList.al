report 50024 "Sales Shipment Packing List"
{
    Caption = 'Sales Shipment Packing List';
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50024.SalesShipmentPackingList.rdl';
