report 50022 "Picking List-ALGO"
{
    // version NAVW113.00
    // copy from R5752

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50022.PickingListALGO.rdl';
        ...
        dataitem("Warehouse Activity Header"; "Warehouse Activity Header")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Warehouse Activity Line"; "Warehouse Activity Line")
                {
                    ...
                    DataItemTableView = SORTING("Activity Type", "No.", "Sorting Sequence No.") where("Action Type" = filter('Prélever'));
