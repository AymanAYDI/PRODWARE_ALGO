report 50037 "Items Barcode MP ALGO"
{

    // Report dupliqué du R50036
    // Il a été modifié au niveau du RDL principalement 
    // pour générer une étiquette pour le QRROBOT
    // Demande de Jerome / Avril 2020


    Caption = 'Etiquette MP ALGO', locked = true;
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50037.ItemsBarcodeMPALGO.rdl';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                column(BarCodeEan13; Item."BarCode EAN13")
                {
                }
