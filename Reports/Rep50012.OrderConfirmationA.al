report 50012 "Order Confirmation - A"
{
    // version NAVW113.01
    //Copy from R205

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50012.OrderConfirmationA.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            //>>ALGO
            column(TxtPaymentMethodCaption; TxtPaymentMethod)
            {
            }
            ...
            column(Bill_to_Address_Cap; FieldCaption("Bill-to Address"))
            {
            }
            //<<ALGO
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    // ALGO20200317 - ajout du champs forme juridique pour un rendu dynamique dans le pieds page
                    column(TxtFooter01; STRSUBSTNO(TxtGFooter01, CompanyInfo."Stock Capital", CompanyInfo."Registration No.", CompanyInfo."APE Code", CompanyInfo."EORI No.", CompanyInfo."Trade Register", CompanyInfo."Legal Form"))
                    {
                    }
                    // ALGO20200317 - ajout du champs forme juridique pour un rendu dynamique dans le pieds page                    
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        //>>ALGO
                        column(SalesLinePO; "Sales Line".PO)
                        {
                        }
                        column(Description_2; "Sales Line"."Description 2")
                        {
                        }
                        //<<ALGO
