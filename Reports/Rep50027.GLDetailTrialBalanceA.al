report 50027 "G/L Detail Trial Balance - A"
{
    // version NAVFR13.00
    // copy from R10804

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50027.GLDetailTrialBalanceA.rdl';
        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem(Date; Date)
            {
                ...
                dataitem("G/L Entry"; "G/L Entry")
                {
                    ...
                    //ALGO20200319 - Solde cumulé au détails
                    ...
                    begin
                        ...
                        //ALGO20200319 - Solde cumulé au détails                        
                        If Memo_AccountGLNo = "G/L Account No." then begin
                            Balance2 := Balance2 + "Debit Amount" - "Credit Amount";
                        end else begin
                            Balance2 := "Debit Amount" - "Credit Amount";
                        end;
                        Memo_AccountGLNo := "G/L Account No.";
                        //ALGO20200319 - Solde cumulé au détails                        
                    end;
