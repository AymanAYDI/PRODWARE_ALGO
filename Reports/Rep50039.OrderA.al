report 50039 "Or der-A"
{
    // version NAVW113.02
    // copy from R405

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50039.OrderA.rdl';
    Caption = 'Order';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            // #DEV FDL DEV Mentions DEV et QUI
            column(DEVcmd; "Development Order")
            {
            }
            column(DEVqui; "Assigned User ID")
            {
            }
            //<<ALGO
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    // ALGO20200319 - Ajout du champs forme juridique en dynamique pour le pieds de page                    
                    ...
                    // ALGO20200319 - Ajout du champs forme juridique en dynamique pour le pieds de page                    
                    column(TxtFooter02; STRSUBSTNO(TxtGFooter02, CompanyInfo."Bank Name", CompanyInfo.IBAN, CompanyInfo."SWIFT Code"))
                    {
                    }
                    // ALGO20200319 - ajout d'une nouvelle ligne de pied de page pour le siege social
                    ...
                    //<<ALGO
                    column(DocDate_PurchHeader; Format("Purchase Header"."Order Date", 0, 4))
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(PurchLineVendorItemNo; "Purchase Line"."Vendor Item No.")
                        {
                        }
                        column(RecGItemVendorItemNo; RecGItem."Vendor Item No.")
                        {
                        }
                        column(PurchLinePromisedReceiptDate; "Purchase Line"."Promised Receipt Date")
                        {
                        }
                        column(PurchLinePO; "Purchase Line"."P.O.")
                        {
                        }
                        column(PurchLineVDocCtrlNo; "Purchase Line"."Vdoc Control No.")
                        {
                        }
                        column(PurchLineVDocCtrlNoBL; "Purchase Line"."Vdoc Delivery Order No.")
                        {
                        }
                        column(PurchLineProdOrderNo; "Purchase Line"."Prod. Order No.")
                        {
                        }
                        //<<ALGO
                        ...
                        begin
                            ...
                            IF "Purchase Line".Type = "Purchase Line".Type::Item then begin
                                RecGItem.GET(PurchLine."No.");
                                DecGVendor := RecGItem."Vendor Item No.";

                                RecLItemTrans.RESET();
                                RecLItemTrans.SETRANGE("Item No.", RecGItem."No.");
                                RecLItemTrans.SETRANGE("Language Code", "Purchase Header"."Language Code");
            ...
            begin
                ...
                IF NOT RecGPaymentMode.GET("Purchase Header"."Payment Method Code") THEN
                    RecGPaymentMode.INIT();
            end;
        }
    }
    ...
    var
        ...
        TxtGFooter1: Label 'We await your CONFIRMATION OF ORDER :';
        TxtGFooter2: Label '(With the forecasts of delivery per reference)';
        // ALGO20200317 - Modification du pied de page avec la forme juridique        
        TxtGFooter01: Label '%6 with the Capital of %1 - Siret No. : %2 - APE Code : %3 - VAT Intracom. No. : %4 - TR : %5';
