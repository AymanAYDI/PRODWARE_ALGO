report 50030 "Sales - Shipment - A"
{
    // version NAVW113.00
    //Copy from R208

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50030.SalesShipmentA.rdl';
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(OrderNoCaption_SalesShptHeader; OrderNoCaptionLbl)
                    {
                    }
                    column(OrderNo_SalesShptHeader; "Sales Shipment Header"."Order No.")
                    {
                    }
                    column(ExternalDocumentNoCaption_SalesShptHeader; ExternalDocumentNoLbl)
                    {
                    }
    ...
    var
        ...
        OrderNoCaptionLbl: Label 'Our Document No.';
        ExternalDocumentNoLbl: Label 'Purchase Order No.';
    //<<ALGO
