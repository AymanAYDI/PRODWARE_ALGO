report 50041 "Purchase - Receipt - A"
{
    // version NAVW113.00
    //Copy from R408

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50041.PurchaseReceiptA.rdl';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            column(VendorShipmentNoCaption; FieldCaption("Vendor Shipment No.") + ' :')
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
                    {
                        ...
                        column(PurchLineVendorItemNo; "Vendor Item No.")
                        {
                        }
                        column(RecGItemVendorItemNo; RecGItem."Vendor Item No.")
                        {
                        }
                        column(PurchLinePromisedReceiptDate; "Promised Receipt Date")
                        {
                        }
                        column(PurchLinePO; "P.O.")
                        {
                        }
                        column(PurchLineVDocCtrlNo; "Vdoc Control No.")
                        {
                        }
                        column(PurchLineProdOrderNo; "Prod. Order No.")
                        {
                        }
                        ...
                        column(Order_DateCaption; fieldcaption("Order Date"))
                        {
                        }
                        ...
                        column(TxtOrderLocationSealed; TxtOrderLocationSealed)
                        {
                        }
                        ...
                        begin
                            ...
                            IF "Purch. Rcpt. Line".Type = "Purch. Rcpt. Line".Type::Item then begin
                                RecGItem.GET("Purch. Rcpt. Line"."No.");
                                DecGVendor := RecGItem."Vendor Item No.";

                                RecLItemTrans.RESET();
                                RecLItemTrans.SETRANGE("Item No.", RecGItem."No.");
                                RecLItemTrans.SETRANGE("Language Code", "Purch. Rcpt. Header"."Language Code");
    ...
    var
        Text002: Label '-- RECEPTION FOURNISSEUR --', Locked = true;
        ...
        ShipmentNoCaptionLbl: Label 'Référence :', Locked = true;
        HeaderDimCaptionLbl: Label 'Header Dimensions';
        LineDimCaptionLbl: Label 'Line Dimensions';
        PaytoAddrCaptionLbl: Label 'Pay-to Address';
        DocDateCaptionLbl: Label 'Date :', Locked = true;
        ...
        //>>ALGO
        TxtGFax: Label '-Fax :', Locked = true;
        TxtGTotRef: Label 'Reference Total   :', Locked = true;
        ...
        TxtTotalAmout: Label 'Total Amount %1 :';
        TxtSealedNo: Label 'Sealed No.';
        TxtOrderLocationSealed: Label 'Order Ref./Location/Sealed No./Prod Order No.';
