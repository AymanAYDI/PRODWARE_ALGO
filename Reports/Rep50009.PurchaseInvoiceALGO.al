report 50009 "Purchase - Invoice - ALGO"
{
    // version NAVW113.00
    // copy from R406

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50009.PurchaseInvoiceALGO.rdl';
    ...
    dataset
    {
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            column(Vendor_Invoice_No_Caption; FieldCaption("Vendor Invoice No."))
            {
            }
            column(TxtVendorInitial; TxtVendorInitial)
            {
            }
            column(TotalAmountInclVAT1; TotalInclVATText)
            {
            }
    ...
    var
        ...
        //>>ALGO
        TxtVendorInitial: Label 'Vendor Initial';
    //<<ALGO
