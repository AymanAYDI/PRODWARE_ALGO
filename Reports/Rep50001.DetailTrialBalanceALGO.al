report 50001 "Detail Trial Balance - ALGO"
{
    // version NAVW113.00
    // copy from R4

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50001.DetailTrialBalanceALGO.rdl';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            column(GLSequenceNoCaption; GLSequenceNoCaptionLbl)
            {
            }
            column(GLLetterCaption; GLLetterCaptionLbl)
            {
            }
    ...
    var
        ...
        GLSequenceNoCaptionLbl: Label 'No Sequence';
        GLLetterCaptionLbl: Label 'ID Lettrage';
