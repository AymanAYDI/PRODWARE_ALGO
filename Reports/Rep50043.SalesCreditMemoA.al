report 50043 "Sales - Credit Memo - A"
{
    // version NAVW113.01
    //Copy from R207

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50043.SalesCreditMemoA.rdl';
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    // ALGO20200318 - ticket 2486 - ajout d'une nouvelle ligne de pied de page pour la forme juridique
                    ...
                    // ALGO20200318 - ticket 2486 - ajout d'une nouvelle ligne de pied de page pour le siege social
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        //>>ALGO
                        column(SalesLinePO; "Sales Cr.Memo Line".PO)
                        {
                        }
                        column(Order_No_; "Order No.")
                        {
                        }
                        column(NetWeight; RecGItem."Weight (Net/Gross)")
                        {
                        }
                        column(CountryOfOrigine; STRSUBSTNO(TxtGOrigin, RecGCountry.Name))
                        {
                        }
                        column(ItemTariffNo; RecGItem."Tariff No.")
                        {
                        }
                        ...
                        column(Composition; Format(RecGItem.Composition))
                        {
                        }
                        column(Leather; format(RecGItem.Leather))
                        {
                        }
                        column(Linning; format(RecGItem.Linning))
                        {
                        }
                        column(MetalPart; format(RecGItem."Metal parts"))
                        {
                        }
                        ...
                        begin
                            ...
                            IF (RecGItem.FIND('-')) THEN BEGIN
                                ...
                                RecLItemTrans.SETRANGE("Language Code", "Sales Cr.Memo Header"."Language Code");
