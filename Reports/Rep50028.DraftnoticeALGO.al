report 50028 "Draft notice - ALGO"
{
    // version NAVFR13.00
    // copy from R10868

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/Rep50028.DraftnoticeALGO.rdl';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem("Bank Account Buffer"; "Bank Account Buffer")
                {
                    ...
                    dataitem("Payment Line"; "Payment Line")
                    {
                        ...
                        column(STRSUBSTNO__Page__1__FORMAT_CurrReport_PAGENO__; StrSubstNo(Text005, CurrReport.PageNo))
                        {
                        }
